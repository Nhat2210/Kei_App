...
exports.ExercisesController = exports.SubmitExerciseDto = void 0;
...
], SubmitExerciseDto.prototype, "user_answer", void 0);
let ExercisesController = class ExercisesController {
    ...
    submitExercise(exerciseId, dto, req) {
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Get exercises for a lesson (answers hidden)' }),
    (0, common_1.Get)('lessons/:id/exercises'),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Submit an answer to an exercise' }),
    (0, common_1.Post)('exercises/:id/submit'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __param(2, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, SubmitExerciseDto, Object]),
    __metadata("design:returntype", void 0)
], ExercisesController.prototype, "submitExercise", null);
