...
let ProgressController = class ProgressController {
    ...
    completeLesson(lessonId, dto, req) {
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Complete a lesson and calculate progress' }),
    (0, common_1.Post)('lessons/:id/complete'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __param(2, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, complete_lesson_dto_1.CompleteLessonDto, Object]),
    __metadata("design:returntype", void 0)
], ProgressController.prototype, "completeLesson", null);
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Get general progress summary' }),
    (0, common_1.Get)('progress/summary'),
